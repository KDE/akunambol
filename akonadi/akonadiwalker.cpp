...
AkonadiWalker::AkonadiWalker(QObject* parent, const QVariantList& args)
    : QObject(parent)
{
    Q_UNUSED(args);
...
void AkonadiWalker::initEmailMonitor()
{
...
void AkonadiWalker::initContactMonitor()
{
...
void AkonadiWalker::initMicroBlogMonitor()
{
...
AkonadiWalker::~AkonadiWalker()
{
}

QStringList AkonadiWalker::sources() const
{
    return QStringList() << "EmailCollections" << "ContactCollections" << "MicroBlogs";
}

void AkonadiWalker::fetchEmailCollectionsDone(KJob* job)
{
...
void AkonadiWalker::fetchContactCollectionsDone(KJob* job)
{
...
void AkonadiWalker::fetchMicroBlogCollectionsDone(KJob* job)
{
...
bool AkonadiWalker::sourceRequestEvent(const QString &name)
{
...
void AkonadiWalker::stopMonitor(const QString &name)
{
...
void AkonadiWalker::emailItemsReceived(const Akonadi::Item::List &items)
{
...
void AkonadiWalker::emailItemAdded(const Akonadi::Item &item, const QString &collection)
{
...
void AkonadiWalker::printMessage(const MessagePtr msg)
{
...
void AkonadiWalker::fetchEmailCollectionDone(KJob* job)
{
    if ( job->error() ) {
        kDebug() << "Job Error:" << job->errorString();
        return;
...
void AkonadiWalker::fetchContactCollectionDone(KJob* job)
{
    if ( job->error() ) {
        return;
    }
...
void AkonadiWalker::fetchMicroBlogDone(KJob* job)
{
    if (job->error()) {
...
void AkonadiWalker::microBlogItemAdded(const Akonadi::Item &item)
{
...
void AkonadiWalker::printContact(const QString &source, const KABC::Addressee &a)
{
    kDebug() << "-----------------------------------";
    kDebug() << source;
    kDebug() << "name" << a.name();
...
void AkonadiWalker::contactItemAdded( const Akonadi::Item &item )
{
