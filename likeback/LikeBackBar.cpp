    ...
    , m_likeBack( likeBack )
{
    ...
    m_likeButton   ->setIcon( QIcon( KStandardDirs::locate( "appdata", "images/likeback_like.png"    ) ) );
    m_dislikeButton->setIcon( QIcon( KStandardDirs::locate( "appdata", "images/likeback_dislike.png" ) ) );
    m_bugButton    ->setIcon( QIcon( KStandardDirs::locate( "appdata", "images/likeback_bug.png" ) ) );
    m_featureButton->setIcon( QIcon( KStandardDirs::locate( "appdata", "images/likeback_feature.png" ) ) );
