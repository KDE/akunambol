...
KFunSyncOpt::KFunSyncOpt(const char *progname) : parser(progname), verbose(NORMAL)
{
...
bool KFunSyncOpt::parseCmdline(int args_num, char** args_val) 
{
...
const char* KFunSyncOpt::getOptionVal(const char *ln)
{ 
