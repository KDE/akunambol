...
#ifndef CALENDARSOURCE_H
#define CALENDARSOURCE_H
...
class CalendarSource : public CacheSyncSource {

    public:


        CalendarSource(const WCHAR* name, AbstractSyncSourceConfig *sc, KeyValueStore* cache) : CacheSyncSource(name, sc, cache)
        {
        }
