...
#ifndef EVENTSSOURCE_H
#define EVENTSSOURCE_H
...
class EventsSource : public AkonadiSource
{
    public:


        EventsSource(const WCHAR* name, AbstractSyncSourceConfig *sc, KeyValueStore* cache);
