...
resourceResource::resourceResource( const QString &id )
  : ResourceBase( id )
{
...
void resourceResource::retrieveCollections()
{
...
void resourceResource::retrieveItems( const Akonadi::Collection &collection )
{
  Q_UNUSED( collection );
...
bool resourceResource::retrieveItem( const Akonadi::Item &item, const QSet<QByteArray> &parts )
{
  Q_UNUSED( item );
  Q_UNUSED( parts );
...
void resourceResource::aboutToQuit()
{
  // TODO: any cleanup you need to do while there is still an active
  // event loop. The resource will terminate after this method returns
}

void resourceResource::configure( WId windowId )
{
  Q_UNUSED( windowId );
...
void resourceResource::itemAdded( const Akonadi::Item &item, const Akonadi::Collection &collection )
{
  Q_UNUSED( item );
  Q_UNUSED( collection );
...
void resourceResource::itemChanged( const Akonadi::Item &item, const QSet<QByteArray> &parts )
{
  Q_UNUSED( item );
  Q_UNUSED( parts );
...
void resourceResource::itemRemoved( const Akonadi::Item &item )
{
  Q_UNUSED( item );
...
AKONADI_RESOURCE_MAIN( resourceResource )

#include "resourceresource.moc"
